...
from tests.utils.logging import setup_logging
from tests.utils.rest_helper import RestHelper
...
class _TypedFailure(  # noqa: PYI059 `Generic[]` should always be the last base class
    Generic[_ExcType_co], Protocol
):
